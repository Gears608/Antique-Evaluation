                    	...
                    	if (password_verify($_POST['password'], $password)) 
                    	{
                                ...
                                if($stmt = $con->prepare($sql)){
                                    ...
                                    if($stmt = $con->prepare($sql)){
                                        ...
                                        $message = '<p>Please use the following code to authenticate your log in: ' .  $authenticate_code . '<br>This code will expire after 10 minutes after which you will have to request a new code.<br>If you did not request an authentication code, it is safe to ignore this email.</p>';
...
<html>
	<head>
		<meta charset="utf-8">
		<title>Authenticate Delete Account</title>
	...
	<body>
		<div class="login">
			<h1>Authenticate</h1>
			<form action="authenticate2FADeleteAccount.php" method="post">
